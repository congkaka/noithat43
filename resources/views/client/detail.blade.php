		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6 col-lg-5 p-b-30">
					...
					<h4 class="price">
                        <p style="font-size: 1.875rem;font-weight: 500;color: #ee4d2d;"><span id="jsprice">300.000đ</span> <span id="jspromotion"></span></p>
                    </h4>
					...
					<div class="single_product_ratings mb-15">
                        ...
                        <div class="widget-desc">
                            <ul>
                                  ...
                                  <li data-target="#product_details_slider" data-slide-to=""><a class="btn-color" data-price="">Kem</a></li>
						...
						<!-- End Color -->
						<div class="widget size mb-30">
                        <h6 class="widget-title">Kích Thước</h6>
                        <div class="widget-desc">
                            <ul>
                             
							<li><a class="btn-size" data-price="" data-promotion-price="">Đỏ</a></li>                                    
                            </ul>
                        </div>
                    </div>
						<!-- End Color --> 
